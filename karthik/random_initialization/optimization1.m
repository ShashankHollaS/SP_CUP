...
load dataset2.mat
%load first_indices_28.mat
%load first_rates_28.mat

for userNo = 24:25
    filename = "user" + num2str(userNo);
    global hd_plus_vi1;
    global channel;
    ...
    thetas = [theta_val' theta_val1' theta_val2'];
    fvals = [fval fval1 fval2];

    save(filename + "_thetas.mat", 'thetas');
    save(filename + "_fvals.mat", 'fvals');
end
