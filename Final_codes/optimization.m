...
%[theta_val1, fval1, exitflag1, output1, final_val1] = ga(@htheta, 4096, [], [], [], [], lb, ub, [], 1:4096, opts1);
...
%[theta_val2, fval2, exitflag2, output2, final_val2] = ga(@htheta, 4096, [], [], [], [], lb, ub, [], 1:4096, opts2);

function y = htheta(theta_tmp)
